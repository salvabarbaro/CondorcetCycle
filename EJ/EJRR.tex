...
We use survey data from the Comparative Study of Electoral Systems \citep{CSES2020}. The dataset includes party and candidate ratings on a non-ipsative $11$-point like-dislike scale (\emph{integer sympathy scales}) for up to nine political parties and candidates, widely utilized in related research \citep[e.g.,][]{Kalandrakis2022, Desai2025}. Such like/dislike data are frequently used to analyze strategic voting. These data serve as strategy-proof reference values that are compared with actual vote casts or voting intentions \citep{Abramson2009, Eggers2024, Nunez2024}. In this sense, we assume that our data are not significantly biased by strategic considerations. Following an established procedure (most recently: \cite{Lachat2024}), we convert the ratings into individual preference orderings.\footnote{
