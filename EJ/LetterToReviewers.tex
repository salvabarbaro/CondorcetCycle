...
\begin{enumerate}
    ...
    %We rely on party ratings to infer party rankings for parliamentary elections, and candidate ratings to infer preference rankings over presidential candidates.
