...
library(vote)
########################################################################
load("resparty.RData")  # consists of res.party
...
#  gather(key = "case", value = "result") %>%
  ...
  summarise(count = n())
print(summary.df)
write.csv(cwinner_party.df, "bootstrap.csv",
          row.names = F)
###
#save.image("~/Documents/Research/Elections/AnnaProjects/CondorcetParadox/Data/bootstrap.RData")
#load("~/Documents/Research/Elections/AnnaProjects/CondorcetParadox/Data/bootstrap.RData")
